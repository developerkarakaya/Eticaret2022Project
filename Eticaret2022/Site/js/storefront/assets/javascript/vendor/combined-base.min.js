    ...
    w.IdeaApp = {
        ...
        search: {
            ...
            submitQuickSearchForm: function (element) {
                ...
                window.location = '/arama/' + searchValue;
            },
        ...
        previewProduct: function (id) {
            $.fancybox.open({
                src: '/urun-onizleme?productId=' + id,
                type: 'ajax'
            });
        },
        ...
        dynamicFormValidate: function () {
            $.each($('[data-selector="dynamic-form"]'), function (i, formElement) {
                ...
                $(formElement).validate({
                    ...
                    messages: {
                        code: {
                            required: "Lütfen " + IdeaApp.helpers.getFormValidateMessage('[data-form-id="' + formId + '"] input[name="code"]') + " giriniz.",
                            minlength: "" + IdeaApp.helpers.getFormValidateMessage('[data-form-id="' + formId + '"] input[name="code"]') + " en az 5 karakter olmalıdır.",
                            maxlength: "" + IdeaApp.helpers.getFormValidateMessage('[data-form-id="' + formId + '"] input[name="code"]') + " en fazla 150 karakter olmalıdır."
                        }
                    },
            ...
            change: function (element) {
                ...
                if (elementType === 'select-one') {
                    ...
                    if (quantity > stockAmount) {
                        ...
                        if (IdeaApp.helpers.isDecimalStockType(element.attr('data-stocktype'))) {
        ...
        previewBar: {
            ...
            saveTheme: function () {
                ...
                if (newAdmin) {
                    window.location = "/newadmin/theme-settings/" + $("#theme-preview-bar [name='theme']").val()
                } else {
        ...
        newsletter: {
            ...
            submitForm: function (element) {
                ...
                var dialogOptions = {
                    url: '/haber-listesi-aydinlatma-metni',
                    data: {
                        anticsrf: anticsrf
                    },
                    success: function (response) {
            ...
            autoComplete: function () {
                ...
                selector.autoComplete({
                    ...
                    source: function (term, response) {
                        $.get('/index.php?do=catalog/search.ajax&q=' + term, function (data) {
                            response(data);
                        });
                    },
        ...
        promotionBar: {
            init: function () {
                ...
                if (localStorage.getItem('ideaBar' + promotionBarId + '') == null) {
                    this.displayControl();
                    jQuery('.idea-promotion-bar').css('display', 'block');
                }
        ...
        helpers: {
            ...
            checkCustomizationFile: function (file) {
                ...
                if (file.size > IdeaCart.customizationConstraints.size) {
                    throw 'Sepete eklemek istediğiniz ürünler için gönderebileceğiniz dosyaların boyutu en fazla ' + IdeaCart.customizationConstraints.readable_size + ' olabilir.';
                }
            ...
            setCustomizationConstraints: function () {
                ...
                IdeaApp.helpers.ajaxRequest({
                    url: '/cart/view_customization_constraints',
                    async: false,
                    success: function (response) {
                        if (!response.success) {
                        ...
                        if (parsedResponse.errorCode === 456002 && element.attr('data-selector') === 'add-to-cart') {
                            if (element.attr('data-context') === 'showcase') {
                                ...
                                if (typeof productUrl !== "undefined") {
                                    ...
                                    window.location = '/product/redirect/' + productId;
                                    return;
                                }
                            }
                            IdeaApp.plugins.notification(parsedResponse.errorMessage, 'warning');
